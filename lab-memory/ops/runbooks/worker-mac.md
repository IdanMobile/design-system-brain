...
- Investigations → `lab-memory/visual/investigations/active/<storyId>.md`
- Patterns → `lab-memory/visual/patterns/`
- Logic specs → `lab-memory/logic/specs/<storyId>.spec.json`
