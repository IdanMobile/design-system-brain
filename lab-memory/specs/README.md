...
`lab-memory/specs-legacy/` as a one-way archive after running
...
3. Designer opens the showcase, clicks an element in the preview, types a
   plain-English description, optionally clicks **✨ Improve with AI**
