...
export interface PortfolioState {
  ...
  rows: PortfolioRow[];
  htmlUrl?: string;
  /** unified | storybook | figma */
  source?: "unified" | "storybook" | "figma";
  tolerance?: number;
  /** First column header — EntryPoint */
  entryPointLabel?: string;
  /** Second column header — Item id */
  itemLabel?: string;
}
...
export type OrchestratorSort = "step_first" | "worst_first";
...
/** Run-all speed toggles + fix-agent model + orchestrator launch config. */
