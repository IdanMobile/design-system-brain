...
### 22. `lab-analyticscharts--revenue` — warn
- Global diff: **0.31%** (over bar)
- Worst hotspot: **2.29%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 23. `lab-analyticscharts--usage` — warn
- Global diff: **0.30%** (over bar)
- Worst hotspot: **2.29%** (over bar)
- Fail reason: `global_and_hotspot`
