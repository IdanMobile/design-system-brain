...
- Global diff: **5.33%** (over bar)
- Worst hotspot: **7.93%** (over bar)
...
- Global diff: **3.69%** (over bar)
- Worst hotspot: **6.02%** (over bar)
- Fail reason: `global_and_hotspot`
...
- Global diff: **3.05%** (over bar)
- Worst hotspot: **5.36%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 7. `lab-tabspanel--activity-active` — fail
...
### 8. `lab-contentlistboard--highlighted` — fail
- Global diff: **2.34%** (over bar)
- Worst hotspot: **3.69%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 12. `lab-featurecard--default` — fail
- Global diff: **1.78%** (over bar)
- Worst hotspot: **3.29%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 13. `lab-navigationbars--top-navigation` — fail
...
### 14. `lab-snackbarstack--default` — fail
...
### 15. `lab-calendarscheduler--compact` — fail
...
### 16. `lab-featurecard--success` — fail
...
### 17. `lab-contentlistboard--compact` — fail
...
### 18. `lab-calendarscheduler--monthly` — fail
...
### 19. `lab-analyticscharts--revenue` — fail
- Global diff: **1.15%** (over bar)
- Worst hotspot: **4.18%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 20. `lab-analyticscharts--usage` — fail
- Global diff: **1.12%** (over bar)
- Worst hotspot: **4.18%** (over bar)
- Fail reason: `global_and_hotspot`
...
- Global diff: **0.97%** (over bar)
- Worst hotspot: **2.81%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 25. `lab-productcard--default` — fail
...
### 26. `lab-overlaystates--drawer` — warn
