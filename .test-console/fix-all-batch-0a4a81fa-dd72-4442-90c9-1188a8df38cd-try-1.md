...
- `lab-contentlistboard--*` — 3: lab-contentlistboard--default, lab-contentlistboard--highlighted, lab-contentlistboard--compact
- `lab-filtersidepanel--*` — 3: lab-filtersidepanel--collapsed, lab-filtersidepanel--left-panel, lab-filtersidepanel--right-panel
- `lab-loginpage--*` — 2: lab-loginpage--filled-credentials, lab-loginpage--default
...
- `lab-calendarscheduler--*` — 3: lab-calendarscheduler--monthly, lab-calendarscheduler--weekdays-only, lab-calendarscheduler--compact
- `mui--*` — 1: mui--showcase
...
### 1. `lab-contentlistboard--default` — error
...
### 2. `lab-contentlistboard--highlighted` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: object is not extensible
...
### 3. `lab-filtersidepanel--collapsed` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: object is not extensible
...
### 4. `lab-filtersidepanel--left-panel` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: object is not extensible
...
### 5. `lab-filtersidepanel--right-panel` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: object is not extensible
...
### 6. `lab-loginpage--filled-credentials` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: object is not extensible
...
- Global diff: **4.40%** (over bar)
- Worst hotspot: **4.40%** (over bar)
...
### 12. `lab-tabspanel--activity-active` — fail
...
### 13. `lab-tabspanel--settings-active` — fail
- Global diff: **1.74%** (over bar)
- Worst hotspot: **3.37%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 14. `lab-button--primary-with-icon` — fail
- Global diff: **1.68%** (over bar)
- Worst hotspot: **2.00%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 15. `lab-pricingpanel--starter` — fail
...
### 16. `lab-navigationbars--bottom-navigation` — fail
...
### 18. `lab-button--large-with-both-icons` — fail
...
### 19. `lab-navigationbars--top-navigation` — fail
...
### 20. `lab-calendarscheduler--monthly` — fail
...
### 21. `lab-calendarscheduler--weekdays-only` — fail
...
### 23. `lab-contentlistboard--compact` — fail
- Global diff: **0.66%** (over bar)
- Worst hotspot: **1.63%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 24. `lab-calendarscheduler--compact` — fail
- Global diff: **0.64%** (over bar)
- Worst hotspot: **2.75%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 25. `lab-featurecard--default` — fail
...
### 26. `lab-complexdashboardcard--default` — warn
...
### 27. `lab-overlaystates--drawer` — warn
...
### 28. `lab-overlaystates--bottom-sheet` — warn
