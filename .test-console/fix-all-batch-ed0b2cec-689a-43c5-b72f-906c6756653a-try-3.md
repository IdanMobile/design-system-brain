...
- `lab-calendarscheduler--*` — 1: lab-calendarscheduler--compact
- `lab-featurecard--*` — 1: lab-featurecard--default
...
### 3. `lab-calendarscheduler--compact` — fail
...
### 4. `lab-featurecard--default` — fail
...
### `snap` — `packages/extractor-playwright/src/extract.ts` (lines 85–125 of 1408)
