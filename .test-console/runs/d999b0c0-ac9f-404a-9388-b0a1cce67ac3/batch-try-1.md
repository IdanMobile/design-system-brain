...
### 1. `lab-button--secondary` — fail
- Global diff: **3.38%** (over bar)
- Worst hotspot: **3.38%** (over bar)
...
### 2. `lab-tabspanel--activity-active` — fail
...
### 3. `lab-tabspanel--settings-active` — fail
...
### 5. `lab-navigationbars--top-navigation` — fail
...
### 6. `lab-calendarscheduler--compact` — fail
...
### 7. `lab-featurecard--success` — fail
...
### 8. `lab-calendarscheduler--monthly` — fail
...
### 9. `lab-calendarscheduler--weekdays-only` — fail
