...
### 1. `lab-productcard--default` — fail
- Global diff: **18.78%** (over bar)
- Worst hotspot: **49.35%** (over bar)
...
### 2. `lab-productcard--dark` — fail
- Global diff: **10.56%** (over bar)
- Worst hotspot: **24.92%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 7. `lab-navigationbars--top-navigation` — fail
- Global diff: **1.14%** (over bar)
...
### 8. `lab-calendarscheduler--compact` — fail
- Global diff: **1.00%** (over bar)
- Worst hotspot: **3.95%** (over bar)
- Fail reason: `global_and_hotspot`
...
- Global diff: **0.78%** (over bar)
- Worst hotspot: **3.62%** (over bar)
- Fail reason: `global_and_hotspot`
