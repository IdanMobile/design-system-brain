...
### 3. `lab-tabspanel--activity-active` — fail
...
### 6. `lab-navigationbars--top-navigation` — fail
...
### 9. `lab-calendarscheduler--monthly` — fail
...
### 10. `lab-calendarscheduler--weekdays-only` — error
...
### 11. `lab-featurecard--default` — fail
