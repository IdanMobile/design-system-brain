...
- Global diff: **2.42%** (over bar)
- Worst hotspot: **3.74%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 22. `lab-productcard--default` — fail
...
### 23. `lab-analyticscharts--revenue` — fail
...
### 24. `lab-analyticscharts--usage` — fail
