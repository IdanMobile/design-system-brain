...
- Global diff: **2.40%** (over bar)
- Worst hotspot: **4.23%** (over bar)
- Fail reason: `global_and_hotspot`
...
- Global diff: **1.88%** (over bar)
- Worst hotspot: **3.96%** (over bar)
- Fail reason: `global_and_hotspot`
...
- Global diff: **0.56%** (over bar)
- Worst hotspot: **2.90%** (over bar)
- Fail reason: `global_and_hotspot`
