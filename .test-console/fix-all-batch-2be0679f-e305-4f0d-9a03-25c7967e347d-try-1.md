...
### 5. `lab-contentlistboard--highlighted` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: Export timed out after 198000ms
...
### 6. `lab-pricingpanel--pro` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: Export timed out after 180000ms
...
### 7. `lab-pricingpanel--starter` — error
- Global diff: **100.00%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Error: Export timed out after 180000ms
...
### 13. `lab-tabspanel--activity-active` — fail
...
### 14. `lab-tabspanel--settings-active` — fail
- Global diff: **1.74%** (over bar)
- Worst hotspot: **3.37%** (over bar)
- Fail reason: `global_and_hotspot`
