...
### 5. `lab-filtersidepanel--collapsed` — fail
...
### 6. `lab-filtersidepanel--left-panel` — fail
...
### 7. `lab-filtersidepanel--right-panel` — fail
- Global diff: **1.80%** (over bar)
- Worst hotspot: **2.71%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 10. `lab-calendarscheduler--compact` — fail
...
### 11. `lab-featurecard--success` — fail
...
### 12. `lab-pricingpanel--pro` — fail
- Global diff: **1.39%** (over bar)
- Worst hotspot: **3.48%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 14. `lab-contentlistboard--compact` — fail
...
### 15. `lab-calendarscheduler--monthly` — fail
...
### 16. `lab-calendarscheduler--weekdays-only` — fail
...
### 17. `lab-pricingpanel--starter` — fail
- Global diff: **0.98%** (over bar)
- Worst hotspot: **2.26%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 19. `lab-featurecard--default` — fail
...
### 21. `lab-contentlistboard--highlighted` — fail
...
### 22. `lab-overlaystates--drawer` — warn
