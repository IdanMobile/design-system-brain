...
- `lab-featurecard--*` — 2: lab-featurecard--default, lab-featurecard--success
...
- `lab-contentlistboard--*` — 1: lab-contentlistboard--compact
- `mui--*` — 1: mui--showcase
...
### 4. `lab-tabspanel--settings-active` — fail
- Global diff: **2.33%** (over bar)
- Worst hotspot: **4.10%** (over bar)
- Fail reason: `global_and_hotspot`
...
- Global diff: **2.74%** (over bar)
- Worst hotspot: **5.25%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 8. `lab-filtersidepanel--left-panel` — fail
...
### 9. `lab-filtersidepanel--right-panel` — fail
- Global diff: **1.80%** (over bar)
- Worst hotspot: **2.71%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 10. `lab-featurecard--default` — fail
- Global diff: **1.65%** (over bar)
- Worst hotspot: **5.57%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 11. `lab-navigationbars--top-navigation` — fail
...
### 12. `lab-pricingpanel--starter` — fail
- Global diff: **2.00%** (over bar)
...
- Global diff: **0.83%** (over bar)
- Worst hotspot: **2.96%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 20. `lab-productcard--default` — fail
...
### 21. `lab-complexdashboardcard--default` — fail
...
### 22. `lab-analyticscharts--revenue` — fail
- Global diff: **0.55%** (over bar)
...
### 23. `lab-analyticscharts--usage` — fail
- Global diff: **0.51%** (over bar)
- Worst hotspot: **2.58%** (over bar)
- Fail reason: `global_and_hotspot`
