...
- Global diff: **2.36%** (over bar)
- Worst hotspot: **4.15%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 6. `lab-filtersidepanel--collapsed` — fail
...
- Global diff: **1.84%** (over bar)
- Worst hotspot: **3.88%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 11. `lab-calendarscheduler--compact` — fail
...
### 12. `lab-featurecard--success` — fail
...
### 13. `lab-contentlistboard--highlighted` — fail
...
- Global diff: **1.39%** (over bar)
- Worst hotspot: **3.10%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 16. `lab-pricingpanel--starter` — fail
- Global diff: **1.30%** (over bar)
- Worst hotspot: **3.20%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 18. `lab-calendarscheduler--weekdays-only` — fail
...
### 20. `lab-complexdashboardcard--default` — fail
...
### 21. `lab-analyticscharts--revenue` — fail
- Global diff: **0.47%** (over bar)
...
### 22. `lab-analyticscharts--usage` — fail
- Global diff: **0.42%** (over bar)
- Worst hotspot: **2.69%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 23. `lab-overlaystates--drawer` — warn
