...
### 7. `lab-pricingpanel--starter` — fail
...
### 12. `lab-contentlistboard--highlighted` — fail
- Global diff: **1.70%** (over bar)
- Worst hotspot: **2.63%** (over bar)
- Fail reason: `global_and_hotspot`
...
### 19. `lab-calendarscheduler--weekdays-only` — fail
...
### 23. `lab-productcard--default` — fail
...
### 24. `lab-analyticscharts--revenue` — fail
...
### 25. `lab-analyticscharts--usage` — fail
