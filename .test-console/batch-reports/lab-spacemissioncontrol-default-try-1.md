...
- `lab-spacemissioncontrol--*` — 1: lab-spacemissioncontrol--default
...
### 1. `lab-spacemissioncontrol--default` — fail
- Global diff: **1.89%** (over bar)
- Worst hotspot: —
- Fail reason: `global_over`
- Compare: /Users/user/Downloads/storybook-to-figma-lab/pixel-diffs/lab-spacemissioncontrol-default/regions/region-01-compare.png
- Storybook: /Users/user/Downloads/storybook-to-figma-lab/pixel-diffs/lab-spacemissioncontrol-default/storybook.png
- Rendered: /Users/user/Downloads/storybook-to-figma-lab/pixel-diffs/lab-spacemissioncontrol-default/rendered.png
- Artifact: /Users/user/Downloads/storybook-to-figma-lab/pixel-diffs/lab-spacemissioncontrol-default/artifact.v2.json
- Scene JSON: /Users/user/Downloads/storybook-to-figma-lab/pixel-diffs/lab-spacemissioncontrol-default/scene.json
...
### `buildLayer` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 2787–2827 of 3598)
...
### `applyTransform` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 1007–1047 of 3598)
...
### `applyBorders` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 1131–1171 of 3598)
...
### `applyCornerRadii` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 1119–1159 of 3598)
...
### `clampNodeWidthToParent` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 58–98 of 3598)
...
### `snap` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 43–83 of 3598)
...
### `snapBoxSize` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 49–89 of 3598)
...
### `snap` — `packages/pixel-test/src/render-html.ts` (lines 21–61 of 2918)
...
function radialGradientShapeCss(layer: {
  shape: "ellipse" | "circle";
  sizeX?: string;
  sizeY?: string;
}): string {
  if (layer.shape === "ellipse" && layer.sizeX && layer.sizeY) {
    return `ellipse ${layer.sizeX} ${layer.sizeY}`;
  }
  return layer.shape;
```
