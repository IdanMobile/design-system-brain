...
### `buildLayer` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 2665–2705 of 3459)
...
### `applyTransform` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 970–1010 of 3459)
...
### `applyBorders` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 1086–1126 of 3459)
...
### `applyCornerRadii` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 1074–1114 of 3459)
...
### `clampNodeWidthToParent` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 58–98 of 3459)
...
### `snap` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 43–83 of 3459)
...
### `snapBoxSize` — `packages/figma-importer-plugin/src/code-v2.ts` (lines 49–89 of 3459)
...
### `snap` — `packages/pixel-test/src/render-html.ts` (lines 21–61 of 2902)
