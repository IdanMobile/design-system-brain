...
export declare const SEMANTIC_COMPONENT_IDS: readonly ["Button", "Checkbox", "Text", "AnalyticsCharts", "CalendarScheduler", "ComplexDashboardCard", "ContentListBoard", "FeatureCard", "FilterSidePanel", "LoadingStates", "LoginPage", "MeetingHomePage", "NavigationBars", "OverlayStates", "PricingPanel", "ProductCard", "RadioGroupField", "SelectField", "SnackbarStack", "TabsPanel", "Screen1", "Screen2", "ScreenNotificationAvater", "MUIShowcase", "MUIWorkspaceScreen", "NeonArcadeScreen", "CryptoChaosDashboard", "FoodFrenzyScreen", "SpaceMissionControl", "RetroTerminalScreen"];
export type SemanticComponentId = (typeof SEMANTIC_COMPONENT_IDS)[number];
export type SemanticNode = SemanticComponentNode | SemanticLayoutNode | SemanticTextNode;
...
export declare function isSemanticComponentId(id: string): id is SemanticComponentId;
export declare function asDevComponentName(id: SemanticComponentId): DevComponentName;
