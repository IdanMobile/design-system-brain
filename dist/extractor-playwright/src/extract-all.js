...
if (!response.ok)
    throw new Error(`Failed to load Storybook index from ${indexUrl}`);
...
await writeFile(resolve(outDir, "stories.index.json"), JSON.stringify({ schemaVersion: "1.0", generatedAt: new Date().toISOString(), baseUrl, stories: manifest }, null, 2));
