...
export type BorderStyleKind = "none" | "hidden" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset";
...
export type FilterEntry = {
    ...
    kind: "brightness" | "contrast" | "grayscale" | "invert" | "saturate" | "sepia" | "opacity";
    value: number;
} | {
    kind: "hue-rotate";
    degrees: number;
...
export type DisplayMode = "block" | "inline" | "inline-block" | "flex" | "inline-flex" | "grid" | "inline-grid" | "none" | "contents" | "table" | "table-row" | "table-cell" | "table-row-group" | "table-header-group" | "table-footer-group" | "list-item" | "other";
